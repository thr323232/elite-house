...
function PricingToggle({
  ...
  const options: Array<{ id: Billing; label: string; badge?: string }> = [
      ...
      <main className="relative z-10">
        ...
        <section className="mx-auto max-w-6xl px-4 pb-6 pt-10 sm:px-6 sm:pb-8 sm:pt-14">
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            {/* RIGHT PANEL (label + 24h trial box removed; EPG retained) */}
        ...
        {/* FEATURES (tightened top padding + kicker removed above title) */}
